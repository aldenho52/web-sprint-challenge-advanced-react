...
test("displays plants in cart", async () => {
  ...
  const peperomiaRosso = screen.getByText(/peperomia rosso/i)
  const stringsOfDolphins = screen.getByText(/string of dolphins/i)
  const snakePlant = screen.getByText(/snake plant/i)
